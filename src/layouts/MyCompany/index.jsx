    ...
    <>
      ...
      >
        <CompanyBox>
          <img
            src={nvidia_logo}
            style={{ height: '12%', borderRadius: '50%', marginLeft: '20px' }}
          />
          <MinContainer style={{ flexDirection: 'column' }}>
            <FontContainer style={{ fontSize: '30px' }}>
              아침운동
              <FontContainer style={{ fontSize: '18px' }}>
                (회사 info) - 아침 8시에 매일 운동하는 계획표
              </FontContainer>
            </FontContainer>
            <MinContainer>
              <MinContainer
              ...
              >
                <FontContainer>
                  상장일:&nbsp;
                  <span style={{ color: '#5A5A5A' }}>2024.08.21 (8일차)</span>
                </FontContainer>
                <FontContainer style={{ marginTop: '10px' }}>
                  발행주식 수:&nbsp;
                  <span style={{ color: '#5A5A5A' }}>100주</span>
                </FontContainer>
              </MinContainer>
              <MinContainer
                style={{ flexDirection: 'column', marginTop: '10px' }}
          ...
          >
            <FontContainer style={{ marginLeft: '0' }}>
              회사매각예상손익
            </FontContainer>
            <Font style={{ color: 'blue' }}>-275,000(-13.75%)</Font>
          </MinContainer>
