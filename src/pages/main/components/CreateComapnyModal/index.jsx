...
const CreateCompany = () => {
    ...
    const { companyList, setCompanyList, activeCompany, setActiveCompany } =
        useCompanyData();
    ...
    const handleCreateCompany = async () => {
        ...
        formData.append(
            "company",
            new Blob([JSON.stringify(newCompany)], { type: "application/json" })
        );
        if (logoImg) {
        ...
        try {
            ...
            console.log(result);
            setCompanyList((prevCompanyData) => [
                ...prevCompanyData,
                newCompany,
            ]);
